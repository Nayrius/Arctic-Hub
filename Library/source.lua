...
edited: 1/26
developers:
v3rm 'Poo	discord Abstract#8007
...
function Library:create(options)
	...
	local License = profile:object("TextLabel", {
		BackgroundTransparency = 1,
	...
	creditsTab:credit{Name = "Nayr", Description = "Script Developer", Discord = "Nayr#3597", V3rmillion = ""}
